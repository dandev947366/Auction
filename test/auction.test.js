...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/
    return auctionInstance.bid(0, {from: accounts[1], value: 6})
    .then(function (result) {
      /*
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      return auctionInstance.bid(2, {from: accounts[4], value: 5})
      ...
      ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', "default address needs not to equal 0x000...")
      /**********
